                            ...
                            <div class="card-body">
                                <div class="border p-4 rounded">
                                    <div class="my-4 text-center">
                                        <img src="{{ asset('backend_assets') }}/images/logos/logo-img.png"
                                            width="250  " alt="" />
                                    </div>
                                        ...
                                        <form class="row g-3" method="POST" action="{{ route('register') }}">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <small style="color: #e20000"
                                                    class="error">{{ $errList['name'] }}</small>
                                            </div>
                                            <div class="col-12">
                                                ...
                                                <small style="color: #e20000"
                                                    class="error">{{ $errList['email'] }}</small>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="input-group" id="show_hide_password">
                                                    <input name="password" type="password"
                                                        ...
                                                        required id="inputChoosePassword" placeholder="Enter Password">
