...
@section('PageTitle', 'Add new Employee')
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <h4 class="d-flex align-items-center mb-3">Add Employee</h4>
            <br>
            <form id="brand_form" action="{{ route('admin-save-vendor') }}" method="POST">
                @csrf
                <div class="row mb-3">
                    <div class="col-sm-3">
                    ...
                    <div class="col-sm-6 text-secondary">
                        ...
                        <small style="color: #e20000" class="error" id="employee_name-error"></small>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-sm-3">
                    ...
                    <div class="col-sm-6 text-secondary">
                        ...
                        <small style="color: #e20000" class="error" id="employee_email-error"></small>
                    </div>
                </div>
                {{-- <div class="row mb-3">
                    <div class="col-sm-3">
