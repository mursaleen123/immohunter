                                ...
                                <td>
                                    <div class="d-flex order-actions">
                                        <a href="" class="" data-bs-toggle="modal"
                                            data-bs-target="#exampleFullScreenModal-{{ $item->brand_id }}"><i
                                                class='bx
                                       bxs-edit'></i></a>
                                            ...
                                            <div class="modal-dialog modal-fullscreen">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="card">
                                                            <div class="card-body">
                                                                <form class="brand_form" action="update_brand"
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        ...
                                                                        <div class="col-sm-9 text-secondary">
                                                                            <input name="brand_name" type="text"
                                                                                class="form-control"
                                                                                value="{{ $item->brand_name }}" required
                                                                                autofocus />
                                                                        ...
                                                                        <div class="col-sm-9 text-secondary">
                                                                            ...
                                                                            <div>
                                                                                <img class="card-img-top"
                                                                                    src="{{ url('uploads/images/brand/' . $item->brand_image) }}"
