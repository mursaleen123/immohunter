                                        ...
                                        <div class="col-lg-11 m-2  align-items-center justify-content-center">
                                            <div class="card p-2">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="d-flex justify-content-between">
                                                        <a href="{{ $item->property_link }}" class="card-link"
                                                            title="{{ $item->property_link }}">
                                                            Visit Site</a>
                                                        <a href="" class="btn btn-sm btn-secondary"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#exampleFullScreenModal-{{ $item->id }}">Details</a>
                                                        <div class="modal fade"
                                                            id="exampleFullScreenModal-{{ $item->id }}" tabindex="-1"
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="card">
                                                                            <div class="card-body">
                                                                                ...
                                                                                <!-- ======= Property Single ======= -->
                                                                                <section
                                                                                    class="property-single nav-arrow-b">
                                                                                    <div class="container">
                                                                                        <div
